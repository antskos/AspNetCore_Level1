...
namespace WebStore.ServiceHosting.Controllers
{
    ...
    public class UsersApiController : ControllerBase
    {
        ...
        [HttpPost("UserName/{name}")] // api/users/UserName/имя_конкретного_пользователя
        ...
        {
            // объект creation_result содержит ошибки, если они возникли при создании нового пользователя
            var creation_result = await _userStore.CreateAsync(user);
            // здесь можно добавить ошибки создания нового пользователя в журнал
        ...
        {
            // объект update_result содержит ошибки, если они возникнут при изменении данных пользователя
        ...
        {
            await _userStore.SetLockoutEndDateAsync(LockoutInfo.User, LockoutInfo.LockoutTime);
